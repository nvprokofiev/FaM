...
class Gradients {
  ...
  private let pink = [#colorLiteral(red: 0.9495453238, green: 0.4185881019, blue: 0.6859942079, alpha: 1),#colorLiteral(red: 0.8123683333, green: 0.1657164991, blue: 0.5003474355, alpha: 1)]
  
  func random() -> TwoColorsGradient {
    ...
    guard var randomColors = colorsTable.values.randomElement() else {
      return (UIColor.gray, .darkGray)
    }
